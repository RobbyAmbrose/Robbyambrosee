...
// Variables
const rootDomain = "robbyambrosee.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "rbstwn"; // Ganti dengan nama workers kalian
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>Robbyambrosee</span>");
